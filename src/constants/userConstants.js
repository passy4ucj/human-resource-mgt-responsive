...
export const USER_DETAILS_ID_REQUEST = 'USER_DETAILS_ID_REQUEST'
export const USER_DETAILS_ID_SUCCESS = 'USER_DETAILS_ID_SUCCESS'
export const USER_DETAILS_ID_FAIL = 'USER_DETAILS_ID_FAIL'
export const USER_DETAILS_ID_RESET = 'USER_DETAILS_ID_RESET'
